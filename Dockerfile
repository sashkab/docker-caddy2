...
RUN set -xe \
    ...
    && xcaddy build v2.4.3 --with github.com/mholt/caddy-webdav --output /usr/bin/caddy \
...
LABEL description="caddy v2 server" maintainer="github@compuix.com" version="2021.06.21"
